...
$info = getinfo($_SESSION['userid'],$time);
?>
<!doctype html>
<html lang="en">
    ...
    <div class="wx_cfb_container wx_cfb_account_center_container">
        <div class="wx_cfb_account_center_wrap">
            ...
            <div class="wx_cfb_entry_list">
                <br>
                <div class="kv_tb_list clearfix">
                    <button class="btn btn-primary kv_item" style="text-align: center;border-radius: 35px;" onclick="window.location.href='marklog.php?time=1'">今日</button>
                    <button class="btn btn-primary kv_item" style="text-align: center;border-radius: 35px;" onclick="window.location.href='marklog.php?time=7'">昨日</button>
                    <button class="btn btn-primary kv_item" style="text-align: center;border-radius: 35px;" onclick="window.location.href='marklog.php?time=30'">30日</button>
                </div>
                <br>
                <table class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center">帐变原因</th>
                    ...
                    ?>
                        <tr align="center">
                            <!--td style="width:30px"><?php echo $con['type']?></td-->
