  ...
  <div class="">
    ...
    <div id="toop">
      ...
      <span class="txtbet">快捷下注</span>
         ...
         <div class="foot-item">
   <div class="foot-box">
    <i class="icon-keybord"><img src="https://alcdn.dgtztz.com/v3.0/Public/images/keybord1.png" style=" margin-top: 0px; "/></i>
    <input type="text" placeholder="名次/内容/金额" id="Message" class="text" />
    <div class="hand-btn-group" style="
    border: 0px solid #f98100;
    background-image: -webkit-linear-gradient(to right,#f98100,#ffbd9e);
    background-image: linear-gradient(to right,#f98100,#ffbd9e);">
    ...
    <div class="play-b">
     <div class="b-left swiper-container-l swiper-container-vertical swiper-container-android">
      <ul class="swiper-wrapper kb1left" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
       <li class="swiper-slide swiper-slide-active">10</li>
       <li class="swiper-slide swiper-slide-active">11</li>
      </ul>
        ...
        <div class="game-hd">
            <div class="menu">
                <ul>
                    ...
                    <li class="gameli"><a href="javascript:;" data-t="2">定位胆</a></li>
                    <li class="gameli"><a href="javascript:;" data-t="3">总和大小单双</a></li>
        ...
        <div class="game-bd">
            ...
            <div class="gamenum game-type-2">
                ...
                <div class="btn-box btn-grounp">
                    ...
                    <a href="javascript:;" class="btn middle-btn" data-val="10">
                        <div class="h5">
                            <h5>10</h5>
                            <p><em>× <?php echo $info['tema'];
                                    ?></em></p>
          ...
          <div class="gamenum game-type-3" style="display: none;">
                ...
                <div class="btn-box btn-grounp">
                    <a href="javascript:;" class="btn large-btn" data-val="大">
                        <div class="h5">
                            <h5>总和大<font>(≥30)</font></h5>
                            <p><em>× <?php echo $info['zongda'];
                                    ?></em></p>
                        </div>
                    </a>
                    <a href="javascript:;" class="btn large-btn" data-val="小">
                        <div class="h5">
                            <h5>总和小<font>(≤29)</font></h5>
                            <p><em>× <?php echo $info['zongxiao'];
                                    ?></em></p>
                        </div>
                    </a>
...
<div class="zytips"><div>数据加载中..</div></div> <script type="text/javascript">
        app.init();
