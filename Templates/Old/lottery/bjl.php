...
<script type="text/javascript">
    ...
    var shareImg = '<?php echo $_SESSION['headimg'];
        ?>';
    var sharedesc = "我正在顶尖娱乐城提供的游戏房间玩耍！赶紧加入吧！[长按收藏]永不丢失加入口！";
    var para = {};
...
<div class="leftdiv">
    <ul>
        ...
        <li class="ulogo"><a href="/qr2.php?room=<?php echo $_SESSION['roomid']; ?>"><img
...
<div id="frameRIGHTH">
  ...
  <div class="user_messages">
      <div class="top">
         <input placeholder="庄闲/金额" type="text" id="Message" style="color:red;font-weight:bold" <? if (get_query_val('fn_setting', 'setting_ischat', array('roomid' => $_SESSION['roomid'])) == 'open') echo 'disabled="disabled"'; ?>>
    <div id="toop">
      ...
      <span class="txtbet">快捷下注</span>
            ...
            <div class="foot-item">
                <div class="foot-box">
                    ...
                    <input type="text" placeholder="庄闲/金额" id="Message" class="text"/>
                    <div class="hand-btn-group"
                         style=" border: 0px solid #f98100; background-image: -webkit-linear-gradient(to right,#f98100,#ffbd9e); background-image: linear-gradient(to right,#f98100,#ffbd9e);">
                    ...
                    <div class="play-b">
                        <div class="b-left swiper-container-l swiper-container-vertical swiper-container-android">
                            <ul class="swiper-wrapper kb1left"
                                style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
                                <li class="swiper-slide swiper-slide-active">任意对</li>
                            </ul>
        ...
        <div class="gamenum game-type-1">
            ...
            <div class="btn-box btn-grounp">
                ...
                <a href="javascript:;" class="btn middle-btn" data-val="任意对">
                    <div class="h5">
                        <h5>任意对</h5>
                        <p><em>× <?php echo $info['anydui']; ?></em></p>
                    </div>
                </a>
            </div>
        </div>
...
<div id="touzhu" class="">
    <div class="pour-info">
        <h4 class="game-tit game-tit-bg" style="font-size:45px;line-height:100px;">百家乐<a href="javascript:;"
                                                                                            class="close">×</a></h4>
        <div class="m-bd">
