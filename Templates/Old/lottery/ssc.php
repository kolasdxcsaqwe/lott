...
<?php
 switch($_COOKIE['game']){
case 'cqssc': $lot = 'fn_lottery3';
    break;
case "jsssc": $lot = 'fn_lottery8';
    break;
case "txffc": $lot = 'fn_lottery16';
    break; 
case "azxy5": $lot = 'fn_lottery18';
    break; 
}
...
<link rel="Stylesheet" type="text/css" href="Style/Old/css/style.css?t=23984d3re" />
    ...
    <div class="game-hd">
      <div class="menu">
        <ul>
          ...
          <li class="gameli"><a href="javascript:;" class="on" data-t="1">猜龙虎</a></li>
                    <li class="gameli"><a href="javascript:;" data-t="2">猜数字</a></li>
                    <li class="gameli"><a href="javascript:;" data-t="4">猜大小单双</a></li>
          <li class="more-game">
            <a href="javascript:;"><img src="/Style/images/game-arrow.png"></a>
            <div class="sub-menu">
                            <a href="javascript:;" data-t="5">猜总和</a>
                            <a href="javascript:;" data-t="3">猜三张</a>
    ...
    <div class="game-bd">
      <div class="gamenum game-type-4" style="display: none;">
        ...
        <div class="btn-box btn-grounp">
          <a href="javascript:;" class="btn mini-btn" data-line="1"><div class="h5">万</div></a>
          <a href="javascript:;" class="btn mini-btn" data-line="2"><div class="h5">千</div></a>
          <a href="javascript:;" class="btn mini-btn" data-line="3"><div class="h5">百</div></a>
          <a href="javascript:;" class="btn mini-btn" data-line="4"><div class="h5">十</div></a>
          <a href="javascript:;" class="btn mini-btn" data-line="5"><div class="h5">个</div></a>
        </div>
        <div class="btn-box btn-grounp">
      ...
      <div class="gamenum game-type-3" style="display: none;">
        <div class="rank-tit"><span class="change"></span></div>
        <div class="btn-box btn-grounp">
          <a href="javascript:;" class="btn large-btn" data-line="前">
            <div class="h5">
              <h5>前三</h5>
              <p>万、千、百</p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-line="中">
            <div class="h5">
              <h5>中三</h5>
              <p>千、百、十</p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-line="后">
            <div class="h5">
              <h5>后三</h5>
              <p>百、十、个</p>
            </div>
        ...
        <div class="btn-box btn-grounp">
          <a href="javascript:;" class="btn middle-btn" data-val="豹子">
            <div class="h5">
              <h5>豹子</h5>
              <p><em>× <?php echo $info['q_baozi'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn middle-btn" data-val="顺子">
            <div class="h5">
              <h5>顺子</h5>
              <p><em>×  <?php echo $info['q_shunzi'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn middle-btn" data-val="对子">
            <div class="h5">
              <h5>对子</h5>
              <p><em>×  <?php echo $info['q_duizi'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn middle-btn" data-val="半顺">
            <div class="h5">
              <h5>半顺</h5>
              <p><em>×  <?php echo $info['q_banshun'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn middle-btn" data-val="杂六">
            <div class="h5">
              <h5>杂六</h5>
              <p><em>×  <?php echo $info['q_zaliu'];?></em></p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="gamenum game-type-1">
        <div class="rank-tit"><span class="change"></span></div>
        <div class="btn-box btn-grounp">
          <a href="javascript:;" class="btn large-btn" data-val="龙">
            <div class="h5">
              <h5>龙</h5>
              <p><em>× <?php echo $info['long'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-val="虎">
            <div class="h5">
              <h5>虎</h5>
              <p><em>× <?php echo $info['hu'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-val="和">
            <div class="h5">
              <h5>和</h5>
              <p><em>× <?php echo $info['he'];?></em></p>
            </div>
          </a>
        </div>
      </div>
      ...
      <div class="gamenum game-type-5" style="display: none;">
        ...
        <div class="btn-box btn-grounp">
          <a href="javascript:;" class="btn large-btn" data-val="大">
            <div class="h5">
              <h5>总和大<font>(≥23)</font></h5>
              <p><em>× <?php echo $info['zongda'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-val="小">
            <div class="h5">
              <h5>总和小<font>(≤22)</font></h5>
              <p><em>× <?php echo $info['zongxiao'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-val="单">
            <div class="h5">
              <h5>总和单</h5>
              <p><em>× <?php echo $info['zongdan'];?></em></p>
            </div>
          </a>
          <a href="javascript:;" class="btn large-btn" data-val="双">
            <div class="h5">
              <h5>总和双</h5>
              <p><em>× <?php echo $info['zongshuang'];?></em></p>
            </div>
          </a>
        </div>
      </div>
