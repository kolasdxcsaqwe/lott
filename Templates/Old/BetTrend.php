...
function syncBull($codes) {

        $cards=array();
        $length=strlen($codes);
        for ( $i = 0; $i < $length; $i++) {
            $cards[$i]=number_format(substr($codes,$i,1));
        }
    ...
    <div class="sub_right  ">
        <div class="sub_r_bot">
            <div class="sub_bot_one">
                ...
                <span class="r"><a
                            href="<? echo 'http://' . $_SERVER['HTTP_HOST'] . '/qr.php?room=' . $roomid . '&g=' . $game ?>"
                            class="g_button btn_orange1" target="_blank">返回游戏</a></span>
        ...
        <table class="sub_table" cellpadding="0" cellspacing="0" border="0" width="980">
            ...
            <?php } elseif ($game == 'lhc') {
                ...
                foreach ($cons as $con) {
                    ...
                    <tr class="<?php echo $line_row; ?>">
                        ...
                        <td>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[0]]]; ?> ball_lenght5  "><?php echo (int)$codes[0];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[0]]; ?></span>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[1]]]; ?> ball_lenght5  "><?php echo (int)$codes[1];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[1]]; ?></span>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[2]]]; ?> ball_lenght5  "><?php echo (int)$codes[2];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[2]]; ?></span>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[3]]]; ?> ball_lenght5  "><?php echo (int)$codes[3];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[3]]; ?></span>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[4]]]; ?> ball_lenght5  "><?php echo (int)$codes[4];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[4]]; ?></span>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[5]]]; ?> ball_lenght5  "><?php echo (int)$codes[5];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[5]]; ?></span>
                            <span>+</span>
                            <span class="  ball_s_ ball_s_<?php echo $ys[$sebo[(int)$codes[6]]]; ?> ball_lenght5  "><?php echo (int)$codes[6];
                                echo '<br>';
                                echo $shengxiao[(int)$codes[6]]; ?></span>
                        </td>
                        ...
                        <!--                                        <td class="--><?php //echo $ys[$thdx];
                        ?><!--">--><?php //echo $thdx;
                        ?><!--</td>-->
                        <!--										<td class="--><?php //echo $ys[$thds];
                        ?><!--">--><?php //echo $thds;
                        ?><!--</td>-->
                        <!--                                        <td class="--><?php //echo $ys[$twdx];
                        ?><!--">--><?php //echo $twdx;
                        ?><!--</td>-->
                    </tr>
                <?php }
            ...
            <?php } elseif ($game == 'twk3') {
                ...
                foreach ($cons as $con) {
                    ...
                    ?>">
                        <td><?php if ($kong == '1') {
                                echo date("H:i:s", strtotime($con['opentime']));
                            } else {
                                echo date("H:i:s", strtotime($con['time']));
                            } ?></td>
                        <td> <?php echo $con['term'];
                            ?> </td>
                        <td>
            ...
            <?php } elseif ($game == 'pl5') {
                ...
                <tr id="th_header">
                    ...
                    <th width="103" class="">期数</th>
                    <th width="380" class="">开奖号码</th>
                    <th width="100" class="">斗牛</th>
                </tr>
                </thead>
                <tbody id="reslist" linNos="0,1,2,5">
                <?php
                select_query("fn_open", '*', "`type` = '$type' and `roomid` = '$roomid' order by `term` desc limit 40");
                while ($con = db_fetch_array()) {
                    $cons[] = $con;
                }
                ...
                foreach ($cons as $con) {
                    ...
                    for ($i = 0; $i < strlen($result); $i++) {
                        $codes[$i] = substr($result, $i, 1);
                    } ?>

                    <tr class="<?php echo $index%2==0?"":"line_row";
                    ?>">
                        <td><?php if ($kong == '1') {
                                echo date("H:i:s", strtotime($con['opentime']));
                            } else {
                        ...
                        <td> <?php echo $con['term'] ?> </td>
                        <td>
                            <?php for ($j = 0; $j < count($codes); $j++) { ?>
                                <span class="  ball_s_ ball_s_blue ball_lenght5  "><?php echo $codes[$j];
                                    ?></span>
                            <?php } ?>
                        </td>
                        <td> <?php echo syncBull($result) ?> </td>
