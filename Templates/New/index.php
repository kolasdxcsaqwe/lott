                        ...
                        <tr>
                            <td style="width:20%; ">
                                <div class="list" style="/*top:0.8rem*/">
                                    ...
                                    <p data-listorder="6" style=""><a style="background:#0099ff;<?php if($sql['display_custom'] == 'false')echo 'display:none';?>" href="javascript:void(0);" onclick="showMask()">联系客服</a></p>
                                    <p data-listorder="2" style=""><a style="background:#FA9F34;<?php if($sql['display_plan'] == 'false')echo 'display:none';?>" href="javascript:void(0);" onclick="showMask()">长龙计划</a></p>
                                    <p data-listorder="3" style=""><a style="background:#80ff80;<?php if($sql['display_extend'] == 'false')echo 'display:none';?>" href="user/tgzq/tgzq.php">推广赚钱</a></p>
                                </div>
                            </td>
                            <td style="width:80%; ">
