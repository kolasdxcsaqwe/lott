...
var initPanel=function () {
    ...
    function makeMulBetPanel()
    {
        ...
        for (let j = 0; j < secTitles[tabIndex - 1].length; j++) {
            ...
            var itemAmount = gameCodes[tabIndex-1]==='dxds'? 4 : 10;
            var items7 = ['大', '小', '单', '双']
        ...
        $(".rank-tit .choose").click(function () {
            ...
            switch (gameCodes[tabIndex-1]) {
                ...
                case 'd1':
                    ...
                    $('.game-type-' + tabIndex + " .btn-box:eq(" + v + ")").find(" a.btn:eq(" + index + ")").click();
                    break
                case 'tw':
                    for (let k = 0; k < secTitles[7].length; k++) {
                        ...
                        {
                            var index = randomNums(10,1)[0]
                            $('.game-type-' + tabIndex + " .btn-box:eq(" + k + ")").find(" a.btn:eq(" + index + ")").click();
                        }
                    }
                    break
            }
