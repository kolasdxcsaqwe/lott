...
$url = "http://localhost:8123/abcaiji/api/xjp28api.php";
...
$qihao = $resp->expect;
$code = fadeGenXY28($resp->opencode);
$term = $resp->expect;
$next_term = $qihao + 1;
...
//    startBot("xy28", "10029",15, 40);
    $html= vpost("http://localhost:8653/robotBet", array("betPeriod" => 15, 'delay'=>0,'roomid'=>'10029','game'=>$game));
    echo "请求机器人返回 ".$html;
} else {
    echo "等待新加坡28刷新<br>";
}
