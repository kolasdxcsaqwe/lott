...
function kaichat($game, $term){
    if($game == 'bjpk10'){    
        ...
        foreach($cons as $con){
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'pk10');
       ...
       $haoma = get_query_val('fn_open','code',"`type` = '2' order by `term` desc limit 1");
        ...
        foreach($cons as $con){
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'xyft');
 ...
 $number3 = (int)$codes[12] + (int)$codes[13] + (int)$codes[14] + (int)$codes[15] + (int)$codes[16] + (int)$codes[17];
    ...
    $haomachuan .= "<span class='pk_8'>".(int)$he."</span>"; 
        ...
        foreach($cons as $con){         
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'jnd28');
		...
		if($con['kongzhi'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'jsmt');
		...
		if($con['kongzhi'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'jssc');
		...
		if($con['kongzhi'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'jsssc');
        ...
        foreach($cons as $con){
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'kuai3');
		...
		if($con['kongzhi'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'bjl');
        ...
        foreach($cons as $con){
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'gd11x5');
		...
		if($con['kongzhi'] == '1')continue;    
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'jssm');
        ...
        foreach($cons as $con){
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'lhc');
		...
		if($con['kongzhi'] == '1')continue;      
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'jslhc');
        ...
        foreach($cons as $con){
         ...
         if($con['kongzhi'] == '1')continue; 
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'twk3');
  ...
  if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'txffc');
  ...
  if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'azxy10');
        ...
        foreach($cons as $con){
         if($con['jsdiy'] == '1')continue;
            ...
            管理员喊话("第 $kjqh 期&nbsp;开&nbsp;奖&nbsp;号&nbsp;码<br><br>$haomachuan<br><br>第 $term 期已开启下注!", $con['roomid'], 'azxy5');
...
function 管理员喊话($Content, $roomid, $game){
    ...
    insert_query("fn_chat", array("username" => "播报员", "headimg" => $headimg, "time" => $datetime, 'content' => $Content, 'game' => $game, 'addtime' => date('H:i:s'), 'type' => 'S3', 'userid' => 'system', 'roomid' => $roomid));
}
