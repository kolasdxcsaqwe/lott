...
//    if($pk10open){
//        if($pk10time + 50 == $pkdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'pk10');
//        }
//        if($pk10time == $pkdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '1' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'pk10');
//        }
...
//    }
//    if($xyftopen){
//        if($xyfttime + 50 == $xyftdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'xyft');
//        }
//        if($xyfttime == $xyftdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '2' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'xyft');
//        }
...
//    }
//    if($cqsscopen){
//        if($cqssctime + 50 == $cqsscdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'cqssc');
//        }
//        if($cqssctime == $cqsscdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '3' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'cqssc');
//        }
...
//    if($xy28open){
//        if($pctime + 50 == $pcdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'xy28');
//        }
//        if($pctime == $pcdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '4' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'xy28');
//        }
...
//    }
//    if($jnd28open){
//        if($jndtime + 50 == $jnddjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'jnd28');
//        }
//        if($jndtime == $jnddjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '5' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'jnd28');
//        }
...
//    }
//    if($jsmtopen){
//        if($jsmttime + 50 == $jsmtdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'jsmt');
//        }
//        if($jsmttime == $jsmtdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '6' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'jsmt');
//        }
...
//    }
//    if($jsscopen){
//        if($jssctime + 50 == $jsscdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'jssc');
//        }
//        if($jssctime == $jsscdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '7' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'jssc');
//        }
...
//    }
//    if($jssscopen){
//        if($jsssctime + 50 == $jssscdjs){
//            Broadcast('------距离封盘还有30秒------<br>请需要下注的用户尽快投注', $roomid, 'jsssc');
//        }
//        if($jsssctime == $jssscdjs){
//            Broadcast('------已封盘,截止投注------<br>第' . get_query_val('fn_open', 'next_term', "`type` = '8' order by `term` desc limit 1") . '期投注已经结束<br>请耐心等待开奖<br>开奖视频结果出来后即可正常下注', $roomid, 'jsssc');
//        }
...
//    }
//}
//echo "PK10倒计时:" . $pkdjs . '<br>' . '幸运飞艇倒计时:' . $xyftdjs . '|' . $xyfttime . '<br>' . '重庆时时彩倒计时:' . $cqsscdjs . '<br>' . '新加坡28倒计时:' . $pcdjs . '<br>' . '加拿大28倒计时:' . $jnddjs . '<br>' . '极速摩托倒计时:' . $jsmtdjs . '<br>' . '极速赛车倒计时:' . $jsscdjs . '<br>' . '极速时时彩倒计时:' . $jssscdjs;
//echo '<br>';
//echo "系统当前时间戳为:";
//echo "";
//echo time();
