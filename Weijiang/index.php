      ...
      <aside class="main-sidebar">
        <section class="sidebar">
          <ul class="sidebar-menu">
            ...
            <li class="<?php if($_GET['m'] == "")echo 'active';?>"><a href="index.php"><i class="fa fa-dashboard"></i> <span>总控制台</span></a></li>
            <li class="<?php if($_GET['m'] == 'ipjc')echo 'active';?>"><a href="index.php?m=ipjc"><i class="fa fa-user-plus"></i> <span>IP检测系统</span></a></li>
            <li class="<?php if($_GET['m'] == "setting")echo 'active';?>"><a href="index.php?m=setting&s=s_setting"><i class="fa fa-cogs"></i> <span>系统设置</span></a></li>
           <!--span class="pull-right-container">
            ...
            <a href="#"><i class="fa fa-gamepad"></i> <span>游戏设置</span>
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['g'] == "bjl")echo 'active';?>"><a href="index.php?m=g_setting&g=bjl"><i class="fa fa-circle-o"></i>百家乐</a></li>
                <li class="<?php if($_GET['g'] == "pk10")echo 'active';?>"><a href="index.php?m=g_setting&g=pk10"><i class="fa fa-circle-o"></i>北京赛车</a></li>
                <li class="<?php if($_GET['g'] == "xyft")echo 'active';?>"><a href="index.php?m=g_setting&g=xyft"><i class="fa fa-circle-o"></i>幸运飞艇</a></li>
                <li class="<?php if($_GET['g'] == "jssc")echo 'active';?>"><a href="index.php?m=g_setting&g=jssc"><i class="fa fa-circle-o"></i>极速赛车</a></li>
                <li class="<?php if($_GET['g'] == "jsmt")echo 'active';?>"><a href="index.php?m=g_setting&g=jsmt"><i class="fa fa-circle-o"></i>极速摩托</a></li>
                <li class="<?php if($_GET['g'] == "jssm")echo 'active';?>"><a href="index.php?m=g_setting&g=jssm"><i class="fa fa-circle-o"></i>极速赛马</a></li>
                <li class="<?php if($_GET['g'] == "cqssc")echo 'active';?>"><a href="index.php?m=g_setting&g=cqssc"><i class="fa fa-circle-o"></i>重庆时时彩</a></li>
                <li class="<?php if($_GET['g'] == "jsssc")echo 'active';?>"><a href="index.php?m=g_setting&g=jsssc"><i class="fa fa-circle-o"></i>极速时时彩</a></li>
                ...
                <li class="<?php if($_GET['g'] == "gd11x5")echo 'active';?>"><a href="index.php?m=g_setting&g=gd11x5"><i class="fa fa-circle-o"></i>广东11选5</a></li>
                <li class="<?php if($_GET['g'] == "kuai3")echo 'active';?>"><a href="index.php?m=g_setting&g=kuai3"><i class="fa fa-circle-o"></i>江苏快三</a></li>
                <li class="<?php if($_GET['g'] == "twk3")echo 'active';?>"><a href="index.php?m=g_setting&g=twk3"><i class="fa fa-circle-o"></i>台湾快三</a></li>
              </ul>
            </li>
            <li class="<?php if($_GET['m'] == "user")echo 'active';?>"><a href="index.php?m=user"><i class="fa fa-group"></i><span>用户管理</span></a></li>
            <li class="<?php if ($_GET['m'] == "buqi") {echo 'active';}?>"><a href="index.php?m=buqi"><i class="fa fa-gear"></i><span>手动补期</span></a></li>

            <li class="<?php if ($_GET['m'] == "singset") {echo 'active';}?>"><a href="index.php?m=singset"><i class="fa fa-gear"></i><span>签到奖励设置</span></a></li>

            <li class="<?php if($_GET['m'] == 'shaying')echo 'active';?>"><a href="index.php?m=shaying"><i class="fa fa-cubes"></i> <span>杀赢管理</span></a></li>
            <li class="<?php if($_GET['m'] == 'addterm')echo 'active';?>"><a href="index.php?m=addterm"><i class="fa fa-cubes"></i> <span>预设开奖</span></a></li>
            <li class="treeview <?php if($_GET['m'] == "report")echo 'active';?>"><a href="#"><i class="fa fa-list-ol"></i> <span>报表统计</span>
            <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
              <ul class="treeview-menu">
                <li class="<?php if($_GET['r'] == 'termcount')echo 'active';?>"><a href="index.php?m=report&r=termcount"><i class="fa fa-circle-o"></i>当期统计</a></li>
                <li class="<?php if($_GET['r'] == "term")echo 'active';?>"><a href="index.php?m=report&r=term"><i class="fa fa-circle-o"></i>已结算报表</a></li>
                <li class="<?php if($_GET['r'] == "none")echo 'active';?>"><a href="index.php?m=report&r=none"><i class="fa fa-circle-o"></i>未结算报表</a></li>
                <?  $vip = get_query_val('fn_room','vip',array('roomid'=>$_SESSION['agent_room']));
                if($vip == '1'){ ?>
                <li class="<?php if($_GET['r'] == "gaidan")echo 'active';?>"><a href="index.php?m=report&r=gaidan"><i class="fa fa-circle-o"></i>修改注单【结算后】</a></li>
                <li class="<?php if($_GET['r'] == "gaidan1")echo 'active';?>"><a href="index.php?m=report&r=gaidan1"><i class="fa fa-circle-o"></i>修改注单【结算前】</a></li>
                <?}else{?>
                <?}?> 
              </ul>
            </li>
            ...
            <span class="pull-right-container">
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['a'] == "up")echo 'active';?>"><a href="index.php?m=manage&a=up"><i class="fa fa-circle-o"></i>上分申请 <span class="label pull-right bg-red fade sf">3</span></a></li>
                <li class="<?php if($_GET['a'] == "down")echo 'active';?>"><a href="index.php?m=manage&a=down"><i class="fa fa-circle-o"></i>下分申请 <span class="label pull-right bg-blue fade xf" >3</span></a></li>
                <li class="<?php if($_GET['a'] == "upmark")echo 'active';?>"><a href="index.php?m=manage&a=upmark"><i class="fa fa-circle-o"></i>上下分报表</a></li>
                <li class="<?php if($_GET['a'] == "pay")echo 'active';?>"><a href="index.php?m=manage&a=pay"><i class="fa fa-circle-o"></i>充值接口管理 <span class="label pull-right bg-green fade pay">3</span></a></li>
                <li class="<?php if($_GET['a'] == "duizhang")echo 'active';?>"><a href="index.php?m=manage&a=duizhang"><i class="fa fa-circle-o"></i>商户提现<span class="label pull-right bg-green fade pay">3</span></a></li>
              <li class="<?php if($_GET['a'] == "hedui")echo 'active';?>"><a href="index.php?m=manage&a=hedui"><i class="fa fa-circle-o"></i>充值核对<span class="label pull-right bg-green fade pay">3</span></a></li>
              </ul>
            </li>
            <li class="<?php if($_GET['m'] == "tui")echo 'active';?>"><a href="index.php?m=tui"><i class="fa fa-cloud-download"></i> <span>退水设置</span></a></li>
            ...
            <span class="label pull-right bg-purple fade msg">3</span>
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['c'] == 'room')echo 'active';?>"><a href="index.php?m=chat&c=room"><i class="fa fa-circle-o"></i>下注监控</a></li>
                <li class="<?php if($_GET['c'] == 'custom')echo 'active';?>"><a href="index.php?m=chat&c=custom"><i class="fa fa-circle-o"></i>客服管理<span class="label pull-right bg-purple fade msg">3</span></a></li>
              </ul>
            </li>
            ...
            <span class="pull-right-container">
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['r'] == 'plan')echo 'active';?>"><a href="index.php?m=robot&r=plan"><i class="fa fa-circle-o"></i>方案管理</a></li>
                <li class="<?php if($_GET['r'] == 'robots')echo 'active';?>"><a href="index.php?m=robot&r=robots"><i class="fa fa-circle-o"></i>机器人管理</a></li>
              </ul>
            </li>
            <li class="<?php if($_GET['m'] == 'extend')echo 'active';?>"><a href="index.php?m=extend"><i class="fa fa-user-plus"></i> <span>代理管理</span></a></li>
            <li class="<?php if($_GET['m'] == 'share')echo 'active';?>"><a href="index.php?m=share"><i class="fa fa-share-square-o"></i> <span>分享二维码</span></a></li>
            <li class="treeview <?php if($_GET['m'] == 'flyorder')echo 'active';?>">
              ...
              <ul class="treeview-menu">
                <li class="<?php if($_GET['f'] == "fly")echo 'active';?>"><a href="index.php?m=flyorder&f=fly"><i class="fa fa-circle-o"></i>飞单设置</a></li>
                <li class="<?php if($_GET['f'] == "old")echo 'active';?>"><a href="index.php?m=flyorder&f=old"><i class="fa fa-circle-o"></i>飞单历史</a></li>
              </ul>
            </li>
            ...
            <li class="<?php if($_GET['m'] == 'buy')echo 'active';?>"><a href="index.php?m=buy"><i class="fa fa-shopping-cart"></i> <span>修改密码</span></a></li>
            <?php }?>
