		...
		function() {
			return function(t) {
				...
				function(t, e, n) {
					...
					function i() {}
					function c(t, e, n) {
						S(t).add("switch", "switch-" + (C.includes(e.size) ? e.size: "default"), e.checked ? j: M),
							h.call(n),
							a.call(n),
							l.call(n),
							f.call(n, n._options.disabled)
					}
					function s(t, e) {
						t.setAttribute("tabindex", 0),
							t.setAttribute("role", "checkbox"),
							t.setAttribute("aria-checked", e.checked),
							t.setAttribute("aria-disabled", e.disabled)
					}
					function u(t, e) {
					...
					function f(t) {
						this._el.disabled = t,
							S(this._switch)[t ? "add": "remove"]("switch-disabled"),
							this._switch.setAttribute("aria-disabled", t)
					}
					function l() {
						...
						try {
							for (var i, c = function() {
									...
									e = e.split(" "),
									 ...
									 s = (0, m.
										 default)(t); ! (n = (i = s.next()).done); n = !0) c()
						} catch(t) {
							o = !0,
								r = t
						} finally {
					...
					r.prototype._init = function(t, e) {
						...
						r.prototype._initElement = function() {
							this._el.style.display = "none",
								void 0 !== this._options.checked ? this._el.checked = Boolean(this._options.checked) : this._options.checked = this._el.checked;
							var t = this._createSwitch();
							s(t, this._options),
								u(t, this._el),
								c(t, this._options, this),
								E.attach(t)
						},
						r.prototype._createSwitch = function() {
							return this._switch = document.createElement("span"),
						...
						r.prototype._initEvents = function() {
							this._events = new b.
							default([["change changeSwitchStateFromCheckbox", this._el], ["click changeSwitchStateFromSwitch", this._switch], ["keypress changeSwitchStateFromKeyboard", this._switch]]),
								d(this._events, this)
						},
						r.prototype._toggle = function(t) {
							this._options.beforeChange.call(this, this._el.checked),
								this._el.checked = void 0 === t ? !this._el.checked: t,
								this._options.onChange.call(this, this._el,this._el.checked);
							var e = this._el.checked ? j: M,
								n = this._el.checked ? M: j;
							this._switch.setAttribute("aria-checked", this._el.checked),
								S(this._switch).add(e).remove(n),
								l.call(this),
								h.call(this),
								a.call(this)
						},
				...
				function(t, e, n) {
					...
					e.
						...
						function t(t, e) {
							...
							try {
								for (var c, u = (0, s.
									default)(t); ! (o = (c = u.next()).done) && (n.push(c.value), !e || n.length !== e); o = !0);
							} catch(t) {
								r = !0,
									i = t
							} finally {
				...
				function(t, e, n) {
					...
					t.exports = function(t, e, n, _, m, w, k) {
						...
						if (N && (E = l(N.call(new t)), E !== Object.prototype && (f(E, C, !0), o || s(E, h) || c(E, h, g))), T && M && M.name !== y && (O = !0, A = function() {
							return M.call(this)
						}), o && !k || !p && !O && j[h] || c(j, h, A), u[e] = A, u[C] = g, m) if (x = {
							values: T ? A: S(y),
							keys: w ? A: S(v),
							entries: L
						},
							k) for (b in x) b in j || i(j, b, x[b]);
					...
					var o = n(17),
						...
						u = function(t, e, n) {
							var a, f, l, h = t & u.F,
								...
								w = p ? o: d ? o[e] : (o[e] || {})[s];
							p && (n = e);
							for (a in n) f = !h && w && void 0 !== w[a],
							f && a in _ || (l = f ? w[a] : n[a], _[a] = p && "function" != typeof w[a] ? n[a] : y && f ? i(l, o) : g && w[a] == l ?
								function(t) {
				...
				function(t, e, n) {
					...
					t.exports = Object.create ||
						function(t, e) {
							var n;
							return null !== t ? (s[u] = o(t), n = new s, s[u] = null, n[c] = t) : n = a(),
								void 0 === e ? n: r(n, e)
						}
				},
				function(t, e, n) {
					...
					t.exports = n(26) ? Object.defineProperties: function(t, e) {
						r(t);
						for (var n, c = i(e), s = c.length, u = 0; s > u;) o.f(t, n = c[u++], e[n]);
						return t
					}
				},
				function(t, e, n) {
				...
				function(t, e, n) {
					...
					t.exports = function(t) {
						var e, n, s;
						return void 0 === t ? "Undefined": null === t ? "Null": "string" == typeof(n = c(e = Object(t), r)) ? n: i ? o(e) : "Object" == (s = o(e)) && "function" == typeof e.callee ? "Arguments": s
					}
				},
				function(t, e, n) {
					t.exports = {
				...
				function(t, e, n) {
					...
					t.exports = {
						...
						def: function(t, e, n) {
							...
							t._f || (t._f = i), o && (o.n = i), t[v]++, "F" !== r && (t._i[r] = i)),
								t
						},
						getEntry: y,
				...
				function(t, e, n) {
					var o = n(19),
						...
						e = t.exports = function(t, e, n, l, h) {
							...
							if (i(g)) {
								for (p = s(t.length); p > m; m++) if (y = e ? _(c(d = t[m])[0], d[1]) : _(t[m]), y === a || y === f) return y
							} else for (v = g.call(t); ! (d = v.next()).done;) if (y = r(v, _, d.value, e), y === a || y === f) return y
						};
					e.BREAK = a,
						e.RETURN = f
				},
				...
				function(t, e, n) {
					...
					t.exports = function(t, e, n, y, g, _) {
						var m = o[t],
							...
							x = w && w.prototype,
							b = {};
						return v && "function" == typeof w && (_ || x.forEach && !c(function() { (new w).entries().next()
						})) ? (w = e(function(e, n) {
							f(e, w, t, "_c"),
								e._c = new m,
							void 0 != n && a(n, g, e[k], e)
						}), d("add,clear,delete,forEach,get,has,set,keys,values,entries,toJSON".split(","),
							function(t) {
								var e = "add" == t || "set" == t;
								t in x && (!_ || "clear" != t) && s(w.prototype, t,
									function(n, o) {
										if (f(this, w, t), !e && _ && !l(n)) return "get" == t && void 0;
										var r = this._c[t](0 === n ? 0 : n, o);
										return e ? this: r
									})
							}), "size" in x && p(w.prototype, "size", {
							get: function() {
								return this._c.size
							}
						})) : (w = y.getConstructor(e, t, g, k), u(w.prototype, n), i.NEED = !0),
							h(w, t),
							b[t] = w,
							r(r.G + r.W + r.F, b),
						_ || y.setStrong(w, t, g),
				...
				function(t, e, n) {
					...
					t.exports = function(t, e) {
						...
						return function(e, s, d) {
							for (var v, y, g = i(e), _ = r(g), m = o(s, d, 3), w = c(_.length), k = 0, x = n ? p(e, w) : u ? p(e, 0) : void 0; w > k; k++) if ((h || k in _) && (v = _[k], y = m(v, k, g), t)) if (n) x[k] = y;
							else if (y) switch (t) {
								case 3:
									return ! 0;
								case 5:
				...
				function(t, e, n) {
					...
					t.exports = function(t) {
						var e;
						return r(t) && (e = t.constructor, "function" != typeof e || e !== Array && !r(e.prototype) || (e = void 0), o(e) && (e = e[i], null === e && (e = void 0))),
							void 0 === e ? Array: e
					}
				},
				function(t, e, n) {
					...
					var o; !
						function() {
							...
							function r(t, e) {
								...
								var o;
								if (e = e || {},
									this.trackingClick = !1, this.trackingClickStart = 0, this.targetElement = null, this.touchStartX = 0, this.touchStartY = 0, this.lastTouchIdentifier = 0, this.touchBoundary = e.touchBoundary || 10, this.layer = t, this.tapDelay = e.tapDelay || 200, this.tapTimeout = e.tapTimeout || 700, !r.notNeeded(t)) {
									for (var i = ["onMouse", "onClick", "onTouchStart", "onTouchMove", "onTouchEnd", "onTouchCancel"], s = this, u = 0, a = i.length; u < a; u++) s[i[u]] = n(s[i[u]], s);
									c && (t.addEventListener("mouseover", this.onMouse, !0), t.addEventListener("mousedown", this.onMouse, !0), t.addEventListener("mouseup", this.onMouse, !0)),
							...
							r.prototype.needsClick = function(t) {
								...
								r.notNeeded = function(t) {
									...
									if (f && (o = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/), o[1] >= 10 && o[2] >= 3 && (e = document.querySelector("meta[name=viewport]")))) {
										if (e.content.indexOf("user-scalable=no") !== -1) return ! 0;
				...
				function(t, e, n) {
					...
					o.prototype.add = function() {
						var t, e;
						for (e = 0; e < arguments.length; e += 1) t = "" + arguments[e],
						r(this, t) >= 0 || c.push.call(this, t);
						return this._elem.className = this.toString(),
							this
					},
						o.prototype.remove = function() {
							var t, e, n;
							for (n = 0; n < arguments.length; n += 1) e = "" + arguments[n],
								t = r(this, e),
							t < 0 || c.splice.call(this, t, 1);
							return this._elem.className = this.toString(),
								this
						},
						...
						o.prototype.toggle = function(t, e) {
							return t += "",
								e === !0 ? this.add(t) : e === !1 ? this.remove(t) : this[this.contains(t) ? "remove": "add"](t)
						},
