...
case "send": $content = $_POST['content'];
    ...
    if($_GET['game'] != ""){
        insert_query('fn_chat', array('username' => '管理员', 'content' => $content, 'addtime' => date('H:i:s'), 'time'=>date('Y-m-d H:i:s',time()), 'headimg' => $headimg, 'type' => 'S1', 'game' => $_GET['game'], 'userid' => 'system', 'roomid' => $_SESSION['agent_room']));
    }else{
