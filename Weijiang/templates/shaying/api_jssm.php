...
echo "<span style='color:red;'>极速赛马</span><br>"; 
date_default_timezone_set("Asia/Shanghai");
error_reporting(E_ALL & ~E_NOTICE & ~E_WARNING);
//ini_set("mssql.datetimeconvert","0");
include_once('../../../Public/config.php');
require_once('./jssmhs.php');
...
insert_query('fn_sopen', array("term" => $openterm, 'code' => $code, 'opentime' => $time, 'type' => $type, 'next_term' => $next_term, 'next_time' => $next_time,'roomid'=>$roomid));
  SM_jiesuan($roomid);
   SM_jiesuan1($roomid,$game,$openterm);
  sleep(4);
...
//$moshi=0;
$moshi=get_query_val('fn_lottery12','shenglv',array('roomid'=>$roomid));                     //模式0赢最多1赢随机2赢最少3随机4输最多5输最少
...
$qianzui="{\"ID\":12,\"code\":\"qq1878336950\",\"lottery\":\"jssm\",\"data\":[{\"expect\":";
