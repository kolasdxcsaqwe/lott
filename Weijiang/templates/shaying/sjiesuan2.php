...
function PC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
...
function LHC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid,'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
...
function JSLHC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
...
function SM_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid,'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
...
function BJL_jiesuan1($roomid,$game,$kaiterm){
...
function X5_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
  ...
  //      if($gamekey=='js11x5') $game = '江苏11选5';
		...
		if($jsdiy == 1)continue;
        $opencode = get_query_val('fn_sopen', 'code', "`term` = '$term' and `type` = '11' and `roomid` = '$roomid'");
        if($opencode == "")continue;
        $codes = explode(',', $opencode);
        if(count($codes) != 5){
            echo 'ERROR!';
...
function MLAFT_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
    foreach($cons as $con){
		...
		if($jsdiy == 1)continue;
        $opencode = get_query_val('fn_sopen', 'code', "`term` = '$term' and `type` = '2' and `roomid` = '$roomid'");
        $opencode = str_replace('10', '0', $opencode);
        if($opencode == "")continue;
        $code = explode(',', $opencode);
        if($zym_1 == '1'){
...
function SSC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
    foreach($cons as $con){
		...
		if($jsdiy == 1)continue;
        $opencode = get_query_val('fn_sopen', 'code', "`term` = '$term' and `type` = '3' and `roomid` = '$roomid'");
        if($opencode == "")continue;
        $codes = explode(',', $opencode);
        if(count($codes) != 5){
            echo 'ERROR!';
...
function JSSSC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
...
function PK10_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
    foreach($cons as $con){
		...
		if($jsdiy == 1)continue;
        $opencode = get_query_val('fn_sopen', 'code', "`term` = '$term' and `type` = '1' and `roomid` = '$roomid'");
        $opencode = str_replace('10', '0', $opencode);
        if($opencode == "")continue;
        $code = explode(',', $opencode);
        if($zym_1 == '1'){
...
function MT_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
...
function JSSC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
...
function K3_jiesuan1($roomid,$game,$kaiterm){
 select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
	while($con = db_fetch_array()){
		$cons[] = $con;
	}
	foreach($cons as $con){
		...
		if($addterm != "" && $addcode != ""){
			...
			$opencode = get_query_val('fn_sopen','code',"`term` = '$term' and `type` = '9' and `roomid` = '$roomid'");
		}
		if($opencode == "") continue;
		$codes = explode(',',$opencode);
...
function TWK3_jiesuan1($roomid,$game,$kaiterm){
 select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
	while($con = db_fetch_array()){
		$cons[] = $con;
	}
...
function TXFFC_jiesuan1($roomid,$game,$kaiterm){
    select_query("fn_chat", '*', array("status" => "未结算",'roomid'=>$roomid, 'game'=>$game, 'term'=>$kaiterm));
    while($con = db_fetch_array()){
        $cons[] = $con;
    }
    foreach($cons as $con){
		...
		if($jsdiy == 1)continue;
        $opencode = get_query_val('fn_sopen', 'code', "`term` = '$term' and `type` = '16' and `roomid` = '$roomid'");
        if($opencode == "")continue;
        $codes = explode(',', $opencode);
        if(count($codes) != 5){
            echo 'ERROR!';
