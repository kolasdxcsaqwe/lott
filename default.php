...
<body id="gamebox">
	...
	<section id="allpage" class="p-index">
		...
		<div class="userbox">
			...
			<div class="gamebox">
				<div data-v-7f2b6a5e="" class="gamebox" style="position: absolute; top: 10.5em;right: 0;z-index: 101;width: 6em;height: 2em;padding-left: .3em;line-height: 2em;background: ;"><a href="/Templates/sign/index.php"><img src="/Style/Home/images/hongbao.gif" title="签到"><i data-v-7f2b6a5e="" class="iconfont icon-double-arrow1"></i></a></div>
        ...
        <div class="ss_nav">
        	...
        	<div class="ss_nav new_ss_nav" style="margin-top: 0px;border:none;margin-left: 0px;overflow:hidden;width:auto;height: auto;">
        		<!--	<i class="iconfont close" data-id="#ss_menu"></i> -->
        		<ul class="lottery" style="padding-right: 25px;padding-left: 25px;width: 720px;">
           <!--  <li style=" width: 50%; ">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=azxy5">
						<img src="/Style/Home/images/azxy5-logo-new.png" title="河内5分彩" style=" width: 95%; ">
		
					</a>
				</li> -->
				<li style=" width: 50%; display:none;">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=txffc">
						<img src="/Style/Home/images/txffc-logo-new.png" title="腾讯分分彩" style=" width: 95%; ">
						<!--<font>腾讯分分彩</font>-->
					</a>
				</li>
				<li style=" width: 50%; ">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=xyft">
						<img src="/Style/Home/images/xyft-logo-new.png" title="幸运飞艇" style=" width: 95%; ">
						<!--<font>幸运飞艇</font>-->
					</a>
				</li>
				<li style=" width: 50%; display:none;">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=cqssc">
						<img src="/Style/Home/images/cqssc1.png" title="重庆欢乐生肖" style=" width: 95%; ">
						<!--		<font>重庆欢乐生肖</font>-->
					</a>
				</li>
				<li style=" width: 50%; ">
				...
				<li style=" width: 50%; ">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=xy28">
						<img src="/Style/Home/images/xjp28_23_10_19.jpg" title="新加坡28" style=" width: 95%; ">
						<!--		<font>加拿大28</font>-->
					</a>
				</li>
				<li style=" width: 50%; ">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=jslhc">
						<img src="/Style/Home/images/jslhc-logo-new.png" title="极速六合彩" style=" width: 95%; ">
						<!--<font>极速六合彩</font>-->
					</a>
				</li>
				...
				<li style=" width: 50%; ">
					<a href="/qr.php?room=<?php echo $_SESSION['roomid']?>&g=jsssc">
						<img src="/Style/Home/images/jsssc-logo-new.png" title="极速时时彩" style=" width: 95%; ">
		...
		<li style=" width: 50%; ">
		   ...
		   <div class="ft">
		   	<div class="nav">
		   		<ul>
		   			<li class="a1"><a href="/qr.php?room=<?php echo $_SESSION['roomid'];?>" class="hover"><span class="ft_icon"></span><div class="ft_nav">游戏大厅</div></a></li>
