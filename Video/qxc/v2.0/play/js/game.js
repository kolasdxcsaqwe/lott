...
function(t) {
    t.Star7 = t.Fantang = t.ChungKing = t.Pcegg = t.Jlk3 = t.Game = t.Six = t.Gd10 = new Class({
...
BW.callback["lottery-chungking"] = function() {
    var t = new Game.ChungKing(this.dom.element.getElement(".lottery"));
    new Lottery.Time({
        type: type,
        callback: function() {
            var e = this,
...
BW.callback["lottery-star7"] = function() {
    var t = new Game.Star7(this.dom.element.getElement(".lottery"));
    new Lottery.Time({
        type: "Star7",
        callback: function() {
            var e = this,
...
BW.callback["lottery-pcegg"] = function() {
    var t = new Game.Pcegg(this.dom.element.getElement(".lottery"));
    new Lottery.Time({
        type: type,
        callback: function() {
            var e = this,
...
BW.callback["lottery-jlk3"] = function() {
    var t = new Game.Jlk3(this.dom.element.getElement(".lottery"));
    new Lottery.Time({
        type: type,
        callback: function() {
            var e = this,
...
BW.callback["lottery-fantang"] = function() {
    var t = new Game.Fantang(this.dom.element.getElement(".fantang"));
    new Lottery.Time({
        type: type,
        callback: function() {
            var e = this,
...
BW.callback["lottery-gd10"] = function() {
    var t = new Game.Gd10(this.dom.element.getElement(".lottery"));
    new Lottery.Time({
        type: "Gd10",
        callback: function() {
            var e = this,
