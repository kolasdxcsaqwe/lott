...
var firstTopDisLayer = cc.Layer.extend({
	...
	g_hostIp = "http://" + location.host + "/Video/pk10/pk10/ajax/index.php",
	...
	pk10 = cc.Layer.extend({
		...
		init: function() {
			...
			$.getJSON(g_hostIp,{ 'dtype': 'jsonp'}, function(b) {
		...
		loadDataFromServer: function(a) {
			...
			$.getJSON(g_hostIp,{ 'dtype': 'jsonp'}, function(a) {
	...
	MidActionLayer = cc.Layer.extend({
		...
		initCarSprite: function(a) {
			...
			b = cc.Sprite.create("sj/res/rank3.png");
			...
			b = cc.Sprite.create("sj/res/rank2.png");
			b.setPosition(cc.p(120, 350));
			...
			a = cc.Sprite.create("sj/res/rank1.png");
...
var ParticleDemo = cc.LayerGradient.extend({
	...
	DemoFlower = ParticleDemo.extend({
		onEnter: function() {
			...
			a = cc.TextureCache.getInstance().addImage("res/ffff.png");
