...
var firstTopDisLayer = cc.Layer.extend({
	...
	g_hostIp = "http://"+location.host+"/Video/ft/xyft/ajax/index.php",
	...
	MidActionLayer = cc.Layer.extend({
		...
		initCarSprite: function(a) {
			...
			b = cc.Sprite.create("res/rank3.png");
			...
			b = cc.Sprite.create("res/rank2.png");
			b.setPosition(cc.p(120, 350));
			...
			a = cc.Sprite.create("res/rank1.png");
