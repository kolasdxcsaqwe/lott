...
?>
	AddList([{"code":"xyft_zhibo_html5","data":["<br><font color='#274e13' style='font-size:35px;'><? echo get_query_val('fn_setting','setting_video',array("roomid"=>$_SESSION['roomid'])); ?></font>"]}]);
<?
}
?>
</script>
